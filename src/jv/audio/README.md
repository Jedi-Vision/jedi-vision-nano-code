...
We utilize the ZeroMQ concurrent networking library. It has bindings in both C and Python, which make it well suited for our use case. For more information about the library, see the [user guide](https://zguide.zeromq.org/).
...
The `ObjectBufer` class provides an easy-to-use message buffer for transferring the object representation data from the Python models to the C spatial audio library.
